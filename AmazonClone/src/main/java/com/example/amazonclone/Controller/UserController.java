...
public class UserController {
    ...
    public ResponseEntity gift(@PathVariable String id , @PathVariable int value){
    ...
    public ResponseEntity redeem(@PathVariable String id, @PathVariable String cardnumber){
